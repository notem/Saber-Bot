...
public class SetupCommand implements Command {
    private static final String BOTOATH_LINK = "https://discordapp.com/api/oauth2/authorize?client_id=" + Main.getBotSelfUser().getId() + "&scope=bot&permissions=0\n";

    private static final String USAGE_EXTENDED = "\nYou can invite Saber to your discord server with " +
            "this link: " + BOTOATH_LINK;

    private static final String USAGE_BRIEF = "**" + BotConfig.PREFIX + "setup** - the steps to getting Saber working on your server.";
    ...
    public void action(String[] args, MessageReceivedEvent event)
    {
        String msg = "If you've not already, Saber will need to be added to your server. To do so, follow the " +
                ...
                " to be configured.\n\n(1) Create a channel named **" + BotConfig.CONTROL_CHAN + "**." +
                ...
                "which Saber will listen to commands with the '" + BotConfig.PREFIX + "' prefix. The full " +
                "list of commands Saber will accept can be found with the " + "!" + "help command.\n\n(2) Create a " +
                "channel named **" + BotConfig.EVENT_CHAN + "**. Again, Saber will need the **Read " +
                ...
                BotConfig.ANNOUNCE_CHAN + "** and give Saber at minimum the **Send Messages** permission." +
                ...
                "Saber her permissions on your default channel and do not create an " + BotConfig.ANNOUNCE_CHAN +
